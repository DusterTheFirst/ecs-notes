...
Functions from a library can be used by putting the library name, a dot, and then the name of the function.
ex: `math.sin()` would be the sin function in the math library
...
Once again, the [docs][python-math-docs] have an exhaustive list of all methods available from the library.
...
[on the official python docs][python-turtle-docs] Just like with the math library, we have to `import`
